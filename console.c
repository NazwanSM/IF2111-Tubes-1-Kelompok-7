...
void displayMainMenu() {
    ...
    printf(COLOR_BOLD_YELLOW"16. "COLOR_OFF "WISHLIST SHOW\n");
    printf(COLOR_BOLD_YELLOW"17. "COLOR_OFF "LOGOUT\n");
    printf(COLOR_BOLD_YELLOW"18. "COLOR_OFF "SAVE\n");
    printf(COLOR_BOLD_YELLOW"19. "COLOR_OFF "QUIT\n");
    printf(COLOR_BOLD_BLUE"\nKetik "COLOR_OFF COLOR_BOLD_RED"HELP"COLOR_OFF COLOR_BOLD_BLUE" untuk bantuan\n"COLOR_OFF);
}