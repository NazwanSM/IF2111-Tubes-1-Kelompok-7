...
void displayMainMenu() {
    ...
    printf(COLOR_BOLD_YELLOW"19. "COLOR_OFF "OPTIMASI RUTE\n");
    printf(COLOR_BOLD_YELLOW"20. "COLOR_OFF "LOGOUT\n");    
    printf(COLOR_BOLD_YELLOW"21. "COLOR_OFF "SAVE" COLOR_CYAN" <nama_file>\n"COLOR_OFF);
    printf(COLOR_BOLD_YELLOW"22. "COLOR_OFF "QUIT\n");
    printf(COLOR_BOLD_BLUE"\nKetik "COLOR_OFF COLOR_BOLD_RED"HELP"COLOR_OFF COLOR_BOLD_BLUE" untuk bantuan\n"COLOR_OFF);
}